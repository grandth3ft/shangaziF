  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage:
            'radial-gradient(circle at 10% 90%, rgba(255,255,255,0.3) 0%, transparent 40%), radial-gradient(circle at 90% 10%, rgba(255,255,255,0.2) 0%, transparent 40%)',
        }}
        aria-hidden="true"
      />
      ...
      <div className="container-content relative">
        ...
        >
          ...
          <motion.p
            variants={fadeInUp}
            className="text-tiny font-semibold tracking-widest uppercase text-white/70 mb-4"
          >
            Change A Life Today
          </motion.p>
          ...
          <motion.h2
            variants={fadeInUp}
            className="font-display text-heading-lg md:text-display-md text-white leading-tight mb-6"
          >
          ...
          <motion.p
            variants={fadeInUp}
            className="text-body-lg text-white/80 mb-10 leading-relaxed"
          >
            Every shilling goes directly to the children. No excessive overheads. No empty
            promises. Just real impact, verified and shared openly.
          </motion.p>

          {/* Quick amount buttons */}
          <motion.div
            variants={fadeInUp}
            className="grid grid-cols-2 xs:flex xs:flex-wrap justify-center gap-3 mb-10"
          >
          ...
          >
            ...
            >
              <Heart
                className="w-5 h-5 fill-terracotta/30 group-hover:fill-terracotta/60 transition-colors"
                aria-hidden="true"
              />
              Donate Now
            </Link>
        ...
        </motion.div>{/* ← closes motion.div (stagger wrapper) */}
      </div>{/* ← closes div.container-content */}
    </section>
  )
}
